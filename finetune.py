...
from modeling import MAEForImageClassification
...
def main():
    ...
    model = MAEForImageClassification.from_pretrained(model_args.model_name_or_path, config=config)
    ...
    if training_args.do_eval:
        ...
        if data_args.max_eval_samples is not None:
            ds["val"] = (
                ds["val"].shuffle(seed=training_args.seed).select(range(data_args.max_eval_samples))
            )
